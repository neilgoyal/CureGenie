...
with st.sidebar:
    ...
    st.write('Made by [your_github_username](https://github.com/your_github_username)')

load_dotenv()

def main():
    st.header("Meal and Workout Planner 💪")
    ...
    if st.button("Generate Plan"):
        if user_input:
            ...
            st.write("Please enter the number of days and your needs to generate a plan.")
